...
<head>
    ...
    <title>Karotoa Spinning Mills Ltd.</title>
...
<body>
    ...
    <section class="container-fluid" id="profile-body">
        <h1>Karotoa Spinning Mills Ltd</h1>
        <div class="container-fluid" id="profile">
            <div class="row" id="profile-row">
                <div class="col-md-12" id="img">
                    <div id="imgGallery" class="imgGallery">
                        <div class="dot-matrix"></div>
                        <img id="slideImg" src="assets/imgs/spin/KSML/K.jpg">                        
                        <script src="assets/js/KSML.js"></script>
                    </div>
                </div>               
            </div>
            ...
            <div class="row" id="profile-row1">
                ...
                <table class="tabContainer" id="tabContainer">
                    ...
                    <tbody>
                        <tr id="tabContainer-tr">
                            <td rowspan="6">KSML</td>
                            <td rowspan="6">50,960</td>
                            <td rowspan="6">3,60,000 sq.ft</td>
                            <td rowspan="6">63,24,000 KG</td>
                            <td rowspan="6">1,800</td>
                            <td>Export Quality Melange Yarn</td>
                            <td rowspan="6">200,00,00,000</td>
                            <td rowspan="6">6</td>
                        </tr>
                        <tr id="tabContainer-tr">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="m1">
                                ...
                                <div id="chartdiv"></div>
                                <script src="./assets/js/KSML_m1.js"></script>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="m2" id="m2">
                                ...
                                <script src="assets/js/KSML_m2.js"></script>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="loc" id="loc">
                                    <div class="gmap_canvas">
                                        <iframe class="gmap_iframe" id="gmap_canvas" src="https://maps.google.com/maps?q=Karotoa%20Spinning%20Mills%2C%20fatu&t=k&z=15&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0">
                                        </iframe>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="container-fluid mt-5 p-5" >
                    <div class="row d-flex justify-content-center align-content-center">
                        <div class="col-12 text-center">
                            <p><span>Factory Location: </span>Shafipur, Kaliakair, Gazipur, 1750</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section style="width:100%;background-color: rgba(0, 0, 0, 0);"></section>
